...
<div class="container">
      ...
      <div class="header_right">
        <ul class="forms_right">
          <li><?php echo "$sql"; ?></li>
          <li><a href="appointment.html"> Log Out</a> </li>
        </ul>
        ...
        <div class="container">
          ...
          <span class="icon-bar"></span>
            ...
            <a class="navbar-brand" href="index.html">
              <h1><span class="fa fa-stethoscope" aria-hidden="true"></span>Quiz Master </h1>
            </a>
          </div>
          <!--/.navbar-header-->
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <nav>
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Give Quiz <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    <li><a href="codes.html">Theory Of Computation</a></li>
                    <li class="divider"></li>
                    <li><a href="icons.html">Software Engineering</a></li>
                    <li class="divider"></li>
                    
                  </ul>
                </li>
                <li><a href="departments.html">History Details</a></li>
