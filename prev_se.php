...
$ans=$_GET["ans"];
$next_que_no=$_GET["que"];


///$_SESSION['ans'][$next_que_no]=$ans;
//$ans1=$_SESSION['ans'][$next_que_no];

$next_que_id=$_SESSION['que_id'][$next_que_no];
$ansquery="Select * from se_qbank where id='$next_que_id'";
$exe1=mysqli_query($con,$ansquery);
$a=mysqli_fetch_array($exe1,MYSQLI_NUM);
//score increment logic
if($ans==(2||3||4||5))
	$_SESSION['ans'][$next_que_no]=$a[$ans];
else
	$_SESSION['ans'][$next_que_no]='';

$ans=$_SESSION['ans'][$next_que_no];
if($ans==$a[6])
{	
	$_SESSION['cans'][$next_que_no]='1';
	$score=$_SESSION['cans'][$next_que_no];
	//$score++;
	//$_SESSION['score']=$score;
}
else
{
	$_SESSION['cans'][$next_que_no]='0';
	$score=$_SESSION['cans'][$next_que_no];

}

//$_SESSION['ans'][$next_que_no]=$ans;	
$current_que_no=$next_que_no-1;
$current_que_id=$_SESSION['que_id'][$current_que_no];
$query="Select * from se_qbank where id='$current_que_id'";
...
if($current_que_no>1)
{		
		if($_SESSION['ans'][$current_que_no]==$a[2])
		{
		echo"<table>
	<tr>
...
else if($_SESSION['ans'][$current_que_no]==$a[3])
{
	echo"
	<table>
	<tr>
...
else if($_SESSION['ans'][$current_que_no]==$a[4])
{
	echo"
	<table>
	<tr>
...
else if($_SESSION['ans'][$current_que_no]==$a[5])
{
	echo"
	<table>
	<tr>
...
{
//if(isset($_SESSION['ans'][$current_que_no]))
if($_SESSION['ans'][$current_que_no]==$a[2])
{
	echo"
	<table>
