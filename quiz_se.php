...
<head>
 ...
 <script type="text/javascript">
      var hour=0,minutes=0,seconds=20;
...
$query="Select * from se_qbank order by Rand() Limit 100";
...
<div>
	...
	<form method="post" name="quiz" id="quiz" action="result_se.php" style="color: black;">
