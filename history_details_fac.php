          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <nav>
              <ul class="nav navbar-nav">
                ...
                <li><a href="history_details_fac.php" class="active">History Details</a></li>
...
<?php
  ...
  $item = "select * from history_details";
  $res = $db->get($item);
?>
  <div class="limiter">
    <div class="container-table100">
      <div class="wrap-table100">
        <div class="table100">
          ...
          <th class="column5"><center>Start Time</center></th>
          <th class="column5"><center>End Time</center></th>
          <th class="column5"><center>Quiz Duration(Sec)</center></th>
